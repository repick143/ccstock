...
- 运行时间：2026-07-10 17:01（Asia/Shanghai）
- 交付目录：`cg_task/output/202607101701`
...
- `stock_list_scored_20260710.csv`：本轮交付表备份。
- `stock_list_scored_20260710.xlsx`：Excel 版本交付表。
- `stock_list_scored_20260710.json`：保留全部抓取字段、评分细项与错误信息的结构化明细。
- `stock_list_scoring_report_20260710.md`：评分标准、Top 排名、异常样本和数据完整性说明。
- `cg_task/file/stock_list(2).csv`：已按本轮有效结果回填。

## Profile 更新

- 已更新 152 个 profile；新增 0 个 profile。
- 每个 profile 已追加 `2026-07-10 17:01 CST 预测更新`，并将顶部摘要、核心指标、资料来源和数据异常说明刷新到本轮口径。
